...
{
    [ObservableProperty] private string _databaseType = string.Empty;
    ...
    {
        DatabaseType = Global.Get<IUserSetting>().DatabaseType;
    ...
    {
        Global.Get<IUserSetting>().DatabaseType = DatabaseType;
